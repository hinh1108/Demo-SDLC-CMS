...
| 4 Implementation | 🟡 **Đang làm** | Repo (git). 4 slice: Auth+Content list · Workflow (US-05/06) · Editor+versioning (US-01) · Publishing (US-14, BR-05/06+RBAC) — chạy & verify **47/47 e2e**. Feature plan: `specs/feature-plan.md`. Xem `README.md`, `apps/api/` |
